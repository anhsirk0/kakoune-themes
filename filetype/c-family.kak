...
add-highlighter shared/c/code/decorators regex  '[a-zA-Z_0-9]+\(+' 0:function
add-highlighter shared/c/code/ regex '\([a-zA-Z, ._]+\)' 0:arguement
add-highlighter shared/c/code/ regex '[(){}\[\]]' 0:bracket
# c++ specific
